...
@section('body')
<div class="row mb-3">
    <form action="{{route('postLogin')}}" method="POST" class="col-md-6 col-xs-12 offset-md-3 auth-form"
        id="login_form">
        @csrf
        ...
        <div class="form-check">
            <input type="checkbox" {{(old('remember_me'))?'checked':''}} value="true" name="remember_me"
        ...
        @endif
        <div><button type="submit" class="btn btn-primary mt-2">Submit</button>&nbsp; Don't have an account <a
                href="{{route('getRegister')}}">sign up</a> here</div>
